...
const ranking = [
  ...
  },
  {
    ...
    image: "http://localhost:3000/avatar_6.png",
  },
  {
    id: "4",
    fullName: "Carlo neri",
    ...
    points: 15000,
    office: "Ufficio di Sassuolo",
    image: "http://localhost:3000/avatar_7.png",
  },
  {
    id: "5",
    fullName: "Carlo neri",
  ...
  },
  {
    ...
    points: 12000,
    office: "Ufficio di Sassuolo",
    image: "http://localhost:3000/avatar_10.png",
  },
  {
    id: "8",
    fullName: "Carlo neri",
...
const offices = [
  {
    id: "1",
    name: "Ufficio di Sassuolo",
  },
  { id: "2", name: "Ufficio di Reggio Emilia" },
];
...
export default function Leaderboard() {
  return (
    <PageAnimation className="flex flex-col h-screen gap-6">
      <LeaderboardHeader
        title="Leaderboard"
        subtitle="I Notizieri che stanno facendo la storia"
        className="bg-[#0865DE]"
      />
